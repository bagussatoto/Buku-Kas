...
<div id="sidebar-wrapper">
	<ul class="sidebar-nav">
		...
		<br>
		<li>
			<a style="padding: 10px 0px; margin-left: -20px;" href="http://localhost/CodeIgniter/index.php/cash/login"><span class="glyphicon glyphicon-th-list" style="color: #5bc0de"></span> Entri Cash Data </a>
		</li>
		<li>
